    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Detkcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Detkcoin address"));
    ...
    aboutAction = new QAction(TextColorIcon(":/icons/about"), tr("&About Detkcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Detkcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Detkcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Detkcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Detkcoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Detkcoin Core help message to get a list with possible Detkcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Detkcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Detkcoin network", "", count));
}
...
{
    QString strTitle = tr("Detkcoin"); // default title
